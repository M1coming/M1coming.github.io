...
//耳机音箱
	new Array(
		...
		new Array('images/ej2.jpg','小米圈铁耳机Pro','149元','199人评价'),	
...
//电源
	new Array(
		...
		new Array('images/dy3.jpg','移动电源20000mAh','149元','344人评价'),	
		new Array('','','',''),
...
var vido_con=new Array(
	new Array('小米的呵护','http://player.youku.com/player.php/sid/XMTMwODUxNzAwMA==/v.swf'),
	new Array('红米Nota2 青春首选','http://player.youku.com/player.php/sid/XMTMwODQ0NTY5Ng==/v.swf'),
	new Array('MIUI7性能极速体验','http://player.youku.com/player.php/sid/XODcyMjA1MTQw/v.swf'),
...
//视频
 ...
 var vido_left=(window_w/2)-(vido_w/2)//视频层left数值
$('#vido_div').css('left', vido_left);//设置视频层的初试水平位置

function vido_div_position(){//设置视频层显示时相对窗口正中位置
...
$('.vido_wrap').on('click',function(e){//打开视频
	...
	var vido_src = "<embed src='" + vido_con[i][1] + "'allowFullScreen='true' quality='high' width='907' height='550' align='middle' allowScriptAccess='always' type='application/x-shockwave-flash'></embed>";	
 	$('#vido_src').html(vido_src);//vido_src是弹框中第二部分
 	$('#body_mask').show();//遮罩层
