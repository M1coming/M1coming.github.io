			...
			if(str.indexOf('chrome') != -1 || str.indexOf('firefox') != -1){
				...
				if(typeof (localStorage.getItem('login_name')) == 'undefined' || 
				   ...
				   if(localStorage.getItem('login_icon') == '男'){
						login_src = 'image/talk/port1.png'/*tpa=http://2013.miaov.com/student/Q+/js/image/talk/port1.png*/;
					}
					else{
						login_src = 'image/talk/woman.png'/*tpa=http://2013.miaov.com/student/Q+/js/image/talk/woman.png*/;
					}
				}
												...
												'<div class="commentBox">'+
													...
													'<div class="comments_poster_ft">'+
														'<div class="qzaddons">'+
															...
															'<ul>'+
																'<li>'+
																	'<a href="javascript:;"><img src="image/talk/ve100.gif"/*tpa=http://2013.miaov.com/student/Q+/js/image/talk/ve100.gif*/ /></a>'+
																'</li>'+
																'<li>'+
																	'<a href="javascript:;"><img src="image/talk/ve120.gif"/*tpa=http://2013.miaov.com/student/Q+/js/image/talk/ve120.gif*/ /></a>'+
																'</li>'+
																'<li>'+
																	'<a href="javascript:;"><img src="image/talk/ve163.gif"/*tpa=http://2013.miaov.com/student/Q+/js/image/talk/ve163.gif*/ /></a>'+
																'</li>'+
																'<li>'+
																	'<a href="javascript:;"><img src="image/talk/ve144.gif"/*tpa=http://2013.miaov.com/student/Q+/js/image/talk/ve144.gif*/ /></a>'+
																'</li>'+
																'<li>'+
																	'<a href="javascript:;"><img src="image/talk/ve151.gif"/*tpa=http://2013.miaov.com/student/Q+/js/image/talk/ve151.gif*/ /></a>'+
																'</li>'+
																'<li>'+
																	'<a href="javascript:;"><img src="image/talk/ve105.gif"/*tpa=http://2013.miaov.com/student/Q+/js/image/talk/ve105.gif*/ /></a>'+
																'</li>'+
															'</ul>'+
														'</div>'+
												...
												'<div class="mod-quick-comment">'+
													...
													'<div class="line-list">'+
														'<ul class="quick-comment-list">'+
															'<li>'+
																'<a href="javascript:;"><img src="image/talk/e1000007.gif"/*tpa=http://2013.miaov.com/student/Q+/js/image/talk/e1000007.gif*/></a>'+
															'</li>'+
															'<li>'+
																'<a href="javascript:;"><img src="image/talk/e1000008.gif"/*tpa=http://2013.miaov.com/student/Q+/js/image/talk/e1000008.gif*/></a>'+
															'</li>'+
															'<li>'+
																'<a href="javascript:;"><img src="image/talk/e1000013.gif"/*tpa=http://2013.miaov.com/student/Q+/js/image/talk/e1000013.gif*/></a>'+
															'</li>'+
															'<li>'+
																'<a href="javascript:;"><img src="image/talk/e1000013.gif"/*tpa=http://2013.miaov.com/student/Q+/js/image/talk/e1000013.gif*/></a>'+
															'</li>'+
															'<li>'+
																'<a href="javascript:;"><img src="image/talk/e1000018.gif"/*tpa=http://2013.miaov.com/student/Q+/js/image/talk/e1000018.gif*/></a>'+
															'</li>'+
														'</ul>'+
													'</div>'+
												'</div>'+
