 ...
 Zmenu.prototype={
	  ...
	  createdesk :  function(){
			...
			this.fun.eq(1).click(function(){
				...
				str+='<span>';
				str+='<img src="image/deskicon/folder_o.png"/*tpa=http://2013.miaov.com/student/Q+/js/image/deskicon/folder_o.png*/ alt="" />';
				str+='</span>';
				...
				$('.pos-pare').delegate('li','mousedown',function(ev){
					...
					$(document).mouseup(function(ev){
							...
							ev.pageY<This.oPos.offset().top||ev.pageY>This.oPos.offset().top+This.oPos.outerHeight())
						{
							...
							cleate+='<span>';
							cleate+='<img src="image/deskicon/folder_o.png"/*tpa=http://2013.miaov.com/student/Q+/js/image/deskicon/folder_o.png*/ alt="" />';
							cleate+='</span>';
		...
		setMove   : function(){
				...
				confirmA.eq(0).click(function(){
					...
					$('.pos-pare li').each(function(){
							...
							cleates+='<span>';
							cleates+='<img src="image/deskicon/folder_o.png"/*tpa=http://2013.miaov.com/student/Q+/js/image/deskicon/folder_o.png*/ alt="" />';
							cleates+='</span>';
...
NewCell.prototype = {
		...
		clearLi   :  function(obj){
				...
				if(obj.find('li').html()){
					var src = 'Recycle cs4.png'/*tpa=http://2013.miaov.com/student/Q+/js/Recycle cs4.png*/;
				}
				else
				{
					var src = 'Recycle cs5.png'/*tpa=http://2013.miaov.com/student/Q+/js/Recycle cs5.png*/;
				}
