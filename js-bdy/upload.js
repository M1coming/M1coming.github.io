...
function upload(){	
	...
	xhr.onreadystatechange=function(){ //第四五步监控状态及回调
		if( xhr.readyState===4 ){
			if(xhr.status===200){			
				...
				/*创建文件缩略图*///url: "http://2013.miaov.com/student/xzy/uploads/2015-05-06.zip" url: "../uploads/xmall.jpg"/*tpa=http://2013.miaov.com/student/xzy/uploads/xmall.jpg*/
				...
				switch(type){
					...
					break;		
					case 'zip':
					newItem('background: url(./imgs-bdy/property_icon.png) -155px 0 no-repeat;',name);
					break;
					case 'rar':
					newItem('background: url(./imgs-bdy/property_icon.png) -2145px 0 no-repeat;',name);
					break;
					case 'mp3':
					newItem('background: url(./imgs-bdy/property_icon.png) -1840px 0 no-repeat;',name);
					break;
					case 'mp4':
					newItem('background: url(./imgs-bdy/property_icon.png) -1685px 0 no-repeat;',name);
					break;
					case 'rmvb':
					newItem('background: url(./imgs-bdy/property_icon.png) -1685px 0 no-repeat;',name);
					break;
					case 'doc':
					newItem('background: url(./imgs-bdy/property_icon.png) -460px 0 no-repeat;',name);
					break;
					case 'txt':
					newItem('background: url(./imgs-bdy/property_icon.png) -1070px 0 no-repeat;',name);
					break;
					case 'exe':
					newItem('background: url(./imgs-bdy/property_icon.png) -1380px 0 no-repeat;',name);
					break;
					default:
					newItem('background: url(./imgs-bdy/property_icon.png) no-repeat;',name);
				}
	...
	xhr.open('post','http://2013.miaov.com/student/xzy/js/php/post_file.php',true) //建立数据连接
