...
aInp[0].onblur=function(){	 //用户名	
	...
	var val=this.value
	if(re.test(val)){	
		aSpan[0].style.background="url(../imgs-bdy/btn_icon.gif) -50px -510px no-repeat";	
	}else{
		aSpan[0].style.background='url(../imgs-bdy/btn_icon.gif) -76px -510px no-repeat';		
	}		
}
...
aInp[1].onblur=function(){	 //密码
	...
	var val=this.value
	if(re.test(val)){	
		aSpan[1].style.background="url(../imgs-bdy/btn_icon.gif) -50px -510px no-repeat";	
	}else{
		aSpan[1].style.background='url(../imgs-bdy/btn_icon.gif) -76px -510px no-repeat';
	}	
}
